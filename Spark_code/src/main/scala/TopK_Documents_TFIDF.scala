...
object TopK_Documents_TFIDF {
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf().setAppName("Top-K Documents TFIDF")
    ...
    println(schemaName + "_q" + query + "_" + gender(genderType)  + "_" + (noWords + 1) + "words" + "_TFIDF_" + noTest + " : " + ((t1 - t0) / 1e6) + " (ms)")
  }
}